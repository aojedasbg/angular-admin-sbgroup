  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["users-users-module"], {
    ...
    function Ag98(module, __webpack_exports__, __webpack_require__) {
      ...
      var UsersComponent = /*#__PURE__*/function () {
        function UsersComponent(usersService, router, renderer) {
        ...
        _createClass(UsersComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.dtOptions = {
              ...
              rowCallback: function rowCallback(row, data, index) {
                var self = _this;
                $('#editBtn', row).on('click', function () {
                  _this.rowUserId = data.id;

                  _this.editUserNav(_this.rowUserId);
                });
                $('#deleteBtn', row).on('click', function () {
                  _this.rowUserId = data.id;

                  _this.deleteUsr(_this.rowUserId);
                });
                return row;
              }
            };
          ...
          value: function getUsers() {
            ...
            this.usersService.users().subscribe(function (response) {
              _this2.usersList = response.results;
            });
          }
        }, {
          key: "editUserNav",
          value: function editUserNav(userId) {
            this.router.navigate(['/edit-user', userId]);
          }
        }, {
          key: "deleteUsr",
          value: function deleteUsr(user_id) {
            var _this3 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
              ...
              if (result.isConfirmed === true) {
                _this3.usersService.deleteUser(data).subscribe(function (response) {
      ...
      UsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 8,
        vars: 2,
        consts: [[1, "row", "mb-5"], [1, "col-lg-6", "col-xl-6"], ["routerLink", "/new-user", 1, "btn", "btn-success", "btn-lg", "float-right", 2, "background-color", "#6AA12A", "border-color", "#6AA12A"], [1, "card"], [1, "card-body"], ["datatable", "", 1, "table", "table-striped", "table-bordered", 3, "dtOptions", "dtTrigger"]],
        ...
        directives: [_angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLink"], angular_datatables__WEBPACK_IMPORTED_MODULE_4__["DataTableDirective"]],
