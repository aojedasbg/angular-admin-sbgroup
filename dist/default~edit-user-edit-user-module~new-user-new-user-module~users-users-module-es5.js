      ...
      var UsersService = /*#__PURE__*/function () {
        ...
        _createClass(UsersService, [{
          ...
          value: function segments() {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].sysConfig.apiUrl + 'users/segments', this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
              return response;
          ...
          value: function createUser(data) {
            return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].sysConfig.apiUrl + 'users/create-user', data, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
              return response;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
          ...
          value: function users() {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].sysConfig.apiUrl + 'users/', this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
              return response;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
              var errorArray = [];
              errorArray.push(err);
          ...
          key: "userDetail",
          value: function userDetail(userId) {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].sysConfig.apiUrl + 'users/user-detail', {
              params: {
                user_id: userId
              },
          ...
          value: function deleteUser(data) {
            ...
            return this.http.patch(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].sysConfig.apiUrl + 'users/delete-user', data, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
              return response;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
              var errorArray = [];
              errorArray.push(err);
          ...
          value: function updateUser(data) {
            ...
            return this.http.patch(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].sysConfig.apiUrl + 'users/update-user', data, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
              return response;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
              var errorArray = [];
              errorArray.push(err);
...
//# sourceMappingURL=default~edit-user-edit-user-module~new-user-new-user-module~users-users-module-es5.js.map